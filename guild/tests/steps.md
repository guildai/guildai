...
When we compare the runs:
    ...
    >>> project.compare()
    [['run', 'operation',     'started', 'time', 'status',    'label',    'sourcecode', 'acc', 'loss'],
     ['...', 'm4:evaluate',   '...',     '...',  'completed', 'acc=0.5',  '6764e65b',    0.5,   None],
     ['...', 'm4:train',      '...',     '...',  'completed', 'loss=1.0', '6764e65b',    None,  1.0],
     ['...', 'm4:prepare',    '...',     '...',  'completed',  None,      '6764e65b',    None,  None],
     ['...', 'm4:end-to-end', '...',     '...',  'completed',  None,      '6764e65b',    0.5,   1.0]]
